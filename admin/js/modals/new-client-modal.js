  ...
  var body = ''
    + '<div class="admin-form-row">'
      + '<div class="admin-form-group">'
        ...
        + '<input type="text" class="admin-form-input" id="nc-name" placeholder="Mon Restaurant" autocomplete="organization">'
      + '</div>'
      + '<div class="admin-form-group">'
    ...
    + '<div class="admin-form-row">'
      + '<div class="admin-form-group">'
        ...
        + '<input type="text" class="admin-form-input" id="nc-city" placeholder="Marseille" autocomplete="address-level2">'
      + '</div>'
      + '<div class="admin-form-group">'
    ...
    + '<div class="admin-form-row">'
      + '<div class="admin-form-group">'
        ...
        + '<input type="text" class="admin-form-input" id="nc-owner" placeholder="Prénom Nom" autocomplete="name">'
      + '</div>'
      + '<div class="admin-form-group">'
        + '<label class="admin-form-label">Email</label>'
        + '<input type="email" class="admin-form-input" id="nc-email" placeholder="email@exemple.fr" autocomplete="email">'
      + '</div>'
    + '</div>'
