...
export function renderMorningSummaryCard() {
  ...
  return ''
    + '<div class="ms-inline-card">'
      ...
      + '</div>'
      + '<div class="ms-inline-growth">'
        + '<div class="ms-inline-growth-pill"><span class="ms-inline-growth-val">+142</span><span class="ms-inline-growth-label">followers</span></div>'
        + '<div class="ms-inline-growth-pill"><span class="ms-inline-growth-val">4.7★</span><span class="ms-inline-growth-label">note Google</span></div>'
        + '<div class="ms-inline-growth-pill"><span class="ms-inline-growth-val">#5</span><span class="ms-inline-growth-label">pos. SEO</span></div>'
        + '<div class="ms-inline-growth-pill"><span class="ms-inline-growth-val">' + roiValue + '</span><span class="ms-inline-growth-label">ce mois</span></div>'
      + '</div>'
      + '<div class="ms-inline-agents">'
        + agentLines
      + '</div>'
      + '<div class="ms-inline-footer">'
